        ...
        <div className="auth-branding">
          <div className="auth-branding-content">
            ...
            <h2 className="auth-branding-title">
              Welcome back to <span className="brand-wordmark">Otilor</span>
            </h2>
            <p className="auth-branding-subtitle">
              Sign in to create invoices, track payments, and manage your business finances—all in one place.
            </p>
          ...
          <div className="auth-form-container">
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <div className="auth-form-options">
                ...
                <button type="button" className="auth-forgot-link" onClick={onNavigateToForgotPassword}>
                  Forgot password?
                </button>
              </div>
